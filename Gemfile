...
gem 'dotenv-rails' #Gem to load environment variables from `.env`.
...
gem 'pry-rails' #A runtime developer console and IRB alternative with powerful introspection capabilities.
